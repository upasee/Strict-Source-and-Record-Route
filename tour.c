...
void send_icmp_echo_request(int sockfd, char *ip, int seq){
    ...
    //    memcpy((data + sizeof(struct ip) + sizeof(struct icmp)), icmp_dat, DATALENGTH);
